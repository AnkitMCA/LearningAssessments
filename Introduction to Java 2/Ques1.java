...
Ques.1 Create Java classes having suitable attributes for Library management system.Use OOPs concepts in your design.Also try to use interfaces and abstract classes.
...
public class Ques1 extends LibraryHome implements LibraryUtilities {
    ...
    public static void main(String args[]) {
        ...
        Ques1 obj = new Ques1("Ankit","9090909090","Programming Book");
        obj.getLibraryInfo();
        obj.issueBook();
        obj.returnBook();
